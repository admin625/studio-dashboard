      ...
      try {
        ...
        try {
          const { data: gp, error: gpErr } = await supabase
            ...
            .not('slot_id', 'is', null)
          if (!mounted) return
          if (gpErr) console.warn('[DeliveryView] slot date lookup failed:', gpErr.message)
          else setSlotDates(slotDatesByPost(gp))
        } catch (e) {
  ...
  return (
    <Layout>
      ...
      <div className="mb-6">
        ...
        {planDays.length > 0 && (
          <p className="text-sm font-semibold mt-2" style={{ color: primary }} data-testid="plan-day">
