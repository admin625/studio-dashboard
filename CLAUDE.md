...
`reel_music_library` — see *Reels*), and since 2026-09-21 `generation_attempts` (GenerateModal
polls a run's `outcome` by `client_request_id` after the proxy's 202 — `lib/generationOutcome.js`),
